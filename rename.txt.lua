...
local ReachGroupBox = Tabs.Main:AddRightGroupbox("Automation") do
    ReachGroupBox:AddToggle("AutoRespawn", {
        Text = "Auto Respawn",
        Default = false
    })

    ReachGroupBox:AddToggle("AutoPush", {
        Text = "Auto Push Employees",
        Default = false
    })

    ReachGroupBox:AddDivider()

    ReachGroupBox:AddToggle("AutoTPWhistle", {
        Text = "Enable player whistle teleport",
        Default = false
    })

    ReachGroupBox:AddDropdown("AutoTPWhistlePlayers", {
        SpecialType = "Player",
        Multi = true,
...
elseif Script.IsMines then
    ...
    local Mines_ReachGroupBox = Tabs.Floor:AddRightGroupbox("自动化") do
        Mines_ReachGroupBox:AddButton({
            Text = "自动门200水泵",
            Func = function()
        ...
        Mines_ReachGroupBox:AddToggle("TheMinesAnticheatBypass", {
...
elseif Script.IsRooms then
    ...
    local Rooms_ReachGroupBox = Tabs.Floor:AddRightGroupbox("Automation") do
        Rooms_ReachGroupBox:AddToggle("AutoRooms", {
            Text = "Auto Rooms",
            Default = false
        })

        Rooms_ReachGroupBox:AddLabel("Recommended Settings:\nSpeed Bypass and Noclip disabled", true)

        Rooms_ReachGroupBox:AddDivider()

        Rooms_ReachGroupBox:AddToggle("AutoRoomsDebug", { 
            Text = "Show Debug Info",
            Default = false
        })
        
        Rooms_ReachGroupBox:AddToggle("ShowAutoRoomsPathNodes", { 
...
local ReachGroupBox = Tabs.Main:AddLeftGroupbox("其余主要功能") do
    ...
    ReachGroupBox:AddToggle("AutoInteract", {
        Text = "自动互动",
        Default = false
    ...
    ReachGroupBox:AddDropdown("AutoInteractIgnore", {
        AllowNull = true,
    ...
    ReachGroupBox:AddToggle("AutoWardrobeNotif", {
        Text = "自动" .. Script.HidingPlaceName[Script.Floor.Value] .. "提示",
        Default = false
    })

    ReachGroupBox:AddToggle("AutoWardrobe", {
    ...
    ReachGroupBox:AddToggle("AutoHeartbeat", {
        Text = "自动心跳游戏",
        Default = false,
    ...
    if Script.IsHotel or Script.IsFools then
        ReachGroupBox:AddToggle("AutoLibrarySolver", {
            Text = "自动图书馆密码",
            Default = false
        })

        ReachGroupBox:AddSlider("AutoLibraryDistance", {
            Text = "解锁距离",
            Default = 20,
            Min = 1,
            Max = 100,
        ...
        ReachGroupBox:AddDropdown("AutoBreakerSolverMethod", {
            AllowNull = false,
        ...
        ReachGroupBox:AddToggle("AutoBreakerSolver", {
            Text = "自动电闸盒",
            Default = false
        })
    ...
    elseif Script.IsMines then
        ReachGroupBox:AddToggle("AutoAnchorSolver", {
            Text = "自动锚点",
            Default = false
        })
    end
...
function UICreator:CreateWindow()
    local Window = shared.Library:CreateWindow({
        Title = "mspaint v3| 免费版 | " .. shared.ScriptName,
        Center = true,
        AutoShow = true,
        Resizable = true,
        NotifySide = "Right",
