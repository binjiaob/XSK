...
local creds = window:Tab("下降", "6035145364")
...
local UITab4 = window:Tab("Nico",'18930406865')
local about = UITab4:section("主要功能",true)
...
about:Toggle("怪物刷新提示","Valkiry",false,function(state)
    if state then
            local entityNames = {"bots", "Eyefestation", "Blitz", "Pinkie", "Froger", "Chainsmoker", "Pandemonium", "Body"}  --enity
            local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/1mPger1J')))()
            local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/1mPger1J')))()
