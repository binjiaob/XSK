...
local Window = OrionLib:MakeWindow({IntroText = "XK脚本中心V6.8",Name = "XK脚本中心", HidePremium = false, SaveConfig = true, ConfigFolder = ""})
...
WSBTab:AddParagraph("当前版本","V6.8最新版9月20日更新")
